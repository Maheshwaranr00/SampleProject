...
test('',async()=>{
    ...
    console.log(dta,data2);
     ...
     const discount =Number(dta.DISCOUNT_ENTER)-Number(dta.DISCOUNT);  const A = 0 - discount; const x = 1 +  gst;const basic_cost = A/x;
     const fourth = [rv_amount/x];
     console.log("Discount :"+discount,"IRR : "+ irr, " RV_AMOUNT: " + rv_amount, " BASIC_COST: "+ basic_cost,
     ...
     console.log(base_lease_rental);
     const workbook = new ExcelJS.Workbook();
     await workbook.xlsx.readFile('C:/Users/david/Downloads/Mahesh/script2/scripts/test_results2.xlsx');
     const worksheet = workbook.getWorksheet('TestResultsMinDIS');
